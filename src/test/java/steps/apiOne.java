...
public class apiOne extends GeneralTest {
    ...
    public ValidatableResponse attemptAccessWithValidCredentials(){
    ...
    public void iShouldGetA200Response(int expectedResponse){
        softAssertions.assertThat(attemptAccessWithValidCredentials()).as("Server response different than expected").isEqualTo(expectedResponse);
